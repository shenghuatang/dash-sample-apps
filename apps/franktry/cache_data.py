...
if __name__ == '__main__':
    ...
    logging.info('first call 1')
    slow_function(1)
    logging.info('second call 1')
    slow_function(1)
    logging.info('after call 1')
    '''2020-08-06 10:18:10 INFO     first call 1
2020-08-06 10:18:20 INFO     second call 1
2020-08-06 10:18:20 INFO     after call 1
'''
    app.run_server(debug=True, processes=1)  # in windows, it only support 1,